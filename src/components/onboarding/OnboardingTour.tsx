...
const tourSteps: TourStep[] = [
  ...
  },
  {
    ...
    mobileDescription: "Your main navigation! Tap icons to switch between Home, Customers, Services (center button), Orders, and More.",
    icon: Menu,
    target: "mobile-nav",
  ...
  },
  {
    ...
    mobileDescription: "Manage your customers here. View balances, order history, and send bulk messages.",
  ...
  },
  {
    ...
    mobileDescription: "Manage your services via the center button! Tap to add, edit prices, or import from providers.",
    ...
    mobileAction: "Tap the center button",
  },
  {
    id: "orders",
  ...
  },
  {
    ...
    mobileDescription: "View revenue trends and order stats. Access via the + button or More menu.",
    ...
    mobileAction: "Tap + button or More menu",
  },
  {
    id: "payments",
