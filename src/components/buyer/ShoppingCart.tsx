    ...
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent className="w-full sm:max-w-lg flex flex-col p-0 h-full">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col h-full min-h-0">
          ...
          {/* Cart Tab */}
          <TabsContent value="cart" className="flex-1 flex flex-col m-0 data-[state=active]:flex min-h-0">
            {cart.length === 0 ? (
          ...
          {/* Bulk Add Tab - FIXED LAYOUT */}
          <TabsContent value="bulk" className="flex-1 flex flex-col m-0 data-[state=active]:flex min-h-0">
          ...
          {/* Quick Repeat Tab - FIXED LAYOUT */}
          <TabsContent value="repeat" className="flex-1 flex flex-col m-0 data-[state=active]:flex min-h-0">
            <ScrollArea className="flex-1 w-full min-h-0">
              <div className="p-6 pt-4">
                <QuickRepeatOrder
                  services={services}
