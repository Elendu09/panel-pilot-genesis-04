...
export const FlySMMHomepage = ({ 
  ...
  return (
    <main role="main" className={`min-h-screen font-${fontFamily.toLowerCase()}`} style={{ backgroundColor: bgColor, color: textCol }}>
      ...
      {/* Footer */}
      <footer className="py-12" style={{ backgroundColor: surfaceColor }}>
        <div className="mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-4" style={{ maxWidth: containerMax }}>
          <div className="flex items-center gap-2">
            {displayLogo ? (
              <img src={displayLogo} alt={companyName} className="w-6 h-6 rounded-lg object-contain" loading="lazy" />
            ) : (
              <Rocket className="w-6 h-6" style={{ color: primary }} />
            )}
