...
export const SMMStayHomepage = ({ 
  ...
  return (
    <div className={`min-h-screen font-${fontFamily.toLowerCase()} overflow-hidden`} style={{ backgroundColor: bgColor, color: textCol }}>
          ...
          <div className="flex items-center justify-between">
            <Link to="/" className="flex items-center gap-3">
              <div className="relative">
                {displayLogo ? (
                  <img src={displayLogo} alt={companyName} className="w-10 h-10 rounded-lg object-contain" />
                ) : (
                  <>
      ...
      {/* Hero Section */}
      <section className="relative" style={{ paddingTop: sectionPadding, paddingBottom: sectionPadding }}>
        <motion.div 
