...
const Analytics = () => {
  ...
  const fetchAnalytics = async () => {
    ...
    try {
      ...
      setChanges({
        ...
        orders: calculateChange(totalOrders, prevOrders?.length || 0),
        users: calculateChange(activeUsers, Math.max(1, activeUsers - newCustomersInPeriod.length)),
      });
      setStats({ totalRevenue, totalOrders, activeUsers, conversionRate, successRate, retention: retentionRate });
  ...
  return (
    <div className="space-y-6 overflow-x-hidden">
      ...
      {/* Row 7: Revenue vs Expenses + Top Providers + System Health */}
